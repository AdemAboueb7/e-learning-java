...
public class quizz {
    ...
    public quizz(String matiere, Integer chapitre, String bestg, Integer difficulte, String etat, String gain) {
        this.matiere = matiere;
        this.chapitre = chapitre;
        this.bestg = bestg;
        this.difficulte = difficulte;
    ...
    public Integer getChapitre() { return chapitre; }
    public void setChapitre(Integer chapitre) { this.chapitre = chapitre; }

    public String getBestg() { return bestg; }
    public void setBestg(String bestg) { this.bestg = bestg; }
    ...
    public String toString() {
        return matiere + " - Chapitre " + chapitre + " (Difficulté " + difficulte + ")";
    }
}
